...
#$toolKitSysPrepForm.WindowState = 'Maximized'
$toolKitSysPrepForm.MinimizeBox = $false
$toolKitSysPrepForm.BackColor = 'White'
$toolKitSysPrepForm.StartPosition = 1
$toolKitSysPrepForm.MdiParent = $toolKitApp
$toolKitSysPrepForm.IsMdiChild
$toolKitSysPrepForm.FormBorderStyle = 'None'
...
foreach($name in $domain){
    ...
    Set-Content -Path "$PSScriptRoot\supporting_files" -Value "domain = $toolKitSysPrepDomainStatus.Text" 
...
$toolKitSysPrepNext.Location = '525,675'
$toolKitSysPrepNext.Size = '100,40'
$toolKitSysPrepNext.ResetText() 
...
$toolKitSysPrepCancel.Location = '650,675'
$toolKitSysPrepCancel.Size = '100,40'
$toolKitSysPrepCancel.ResetText() 
