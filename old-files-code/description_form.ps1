$toolKitDescriptionForm = New-Object -TypeName System.Windows.Forms.Form
...
#$toolKitDescriptionForm.WindowState = 'Maximized'
$toolKitDescriptionForm.MinimizeBox = $false
$toolKitDescriptionForm.BackColor = 'White'
$toolKitDescriptionForm.MdiParent = $toolKitApp
$toolKitDescriptionForm.IsMdiChild
$toolKitDescriptionForm.FormBorderStyle = 'None'
...
$toolKitDescriptionNext.Location = '525,300'
...
$toolKitDescriptionCancel.Location = '650,300'
